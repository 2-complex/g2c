                                  ...
                                  int inBitsPerPixel)
{
    ...
    if( width == 0 || height == 0 )
    {
        celloerror( "Attempt to initialize texture with zero height or width.\n" );
        celloerror( "texture: %s\n", name.c_str() );
        exit(0);
    }
                                ...
                                int inBitsPerPixel)
{
    ...
    if( width == 0 )
    {
        celloerror( "Attempt to initialize cubemap with zero height or width.\n" );
        celloerror( "cubemap: %s\n", name.c_str() );
        exit(0);
    }
	...
	const Bitmap& bitmapNegativeZ)
{
    ...
    {
        celloerror( "Attempt to make cube map from images which are not all the same square size.\n" );
        exit(0);
    }
    ...
    {
        celloerror( "Attempt to make cube map from images which are not all the same bit-depth.\n" );
        exit(0);
    }
